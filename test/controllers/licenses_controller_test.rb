...
class LicensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create license" do
    assert_difference('License.count') do
      post licenses_url, params: { license: { subject_id: @license.subject_id, teacher_id: @license.teacher_id } }, as: :json
    end
  ...
  test "should update license" do
    patch license_url(@license), params: { license: { subject_id: @license.subject_id, teacher_id: @license.teacher_id } }, as: :json
    assert_response 200
  end
